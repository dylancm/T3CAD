...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.atopileGetToolchainStatus]: AuthOrchestrationReadScope,
  [WS_METHODS.atopileInstallStart]: AuthOrchestrationOperateScope,
  [WS_METHODS.atopileInstallCancel]: AuthOrchestrationOperateScope,
  [WS_METHODS.atopileInstallSubscribe]: AuthOrchestrationReadScope,
